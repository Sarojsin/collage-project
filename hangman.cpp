...
void saveGameData(const string &playerName, const string &storeName, const string &word, int incorrectGuesses)
{
    ofstream outFile("game_data.txt");
    if (outFile.is_open())
    {
        outFile << "Player Name: " << playerName << endl;
        outFile << "Store Name: " << storeName << endl;
        outFile << "Random Word: " << word << endl;
        outFile << "Incorrect Guesses: " << incorrectGuesses << endl;
        outFile.close();
    }
    else
    {
...
int main()
{
    ...
    cout << "Random word selected: " << word << endl;

    // Get player and store names
    string playerName, storeName;
    ...
    saveGameData(playerName, storeName, word, incorrectGuesses);
